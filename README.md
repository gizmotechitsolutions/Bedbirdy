...
This is a static, display-only site. To view it locally, open `index.html` or `product.html` directly in your browser, or use a development live server (e.g. VS Code Live Server extension) for a smoother experience.
